...
#fix endpoint
#small with large initial condition
...
for(steps in 1:totalsteps)
{
  ...
  if(as.integer(steps/moviestep)==(steps/moviestep))
  {
    ...
    distanceofsmall=((choi[1,6]-15)^2+(choj[1,6]-10)^2)^0.5
    if(distanceofsmall<3 & extendstep==0)
    {
      extendstep=steps/moviestep
      lattice_cho1[choi[1,9],choj[1,9]]=3
      lattice_cho1[choi[1,10],choj[1,10]]=3
      lattice_cho1[choi[1,11],choj[1,11]]=3
      lattice_cho1[choi[1,12],choj[1,12]]=3
      lattice_cho2=lattice_cho1
